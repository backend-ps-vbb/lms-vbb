...
from .views import BookModelViewset,BookInstanceModelViewset,AuthorModelViewset,NoticeModelViewset,MentorModelViewset
#add StudentModelViewset
app_name="api"
router=SimpleRouter()
...
router.register('mentors',MentorModelViewset,basename='Mentors')
